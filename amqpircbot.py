    ...
    if(joined):
        ...
        if(spoolproc==None or spoolproc.poll()!=None):
            ...
            try:
                ...
                consoleoutput("Successfully launched AMQP spool process! Waiting for messages to appear in %s..." % options.ampqspoolpath)
                ircoutput("Successfully launched AMQP spool process! Waiting for messages to appear in %s..." % options.ampqspoolpath)
            except:
